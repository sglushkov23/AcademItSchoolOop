...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Значение первого элемента списка list: " + list.getFirstItemData());

        System.out.println();
        System.out.println("3. Получение/изменение значения по указанному индексу");

        System.out.printf("list = %s; size = %d%n", list, list.getSize());
        System.out.println("Значение элемента списка list по индексу 4: " + list.getItemDataAt(4));

        System.out.println();
        System.out.println("После установки значения -7 по индекксу 1: ");

        Integer oldValue = list.setItemDataAt(1, -7);
        ...
        boolean isRemoved = list.removeItemByData(-7);
        ...
        isRemoved = list.removeItemByData(-9);
        ...
        removedValue = list.removeFirstItem();
